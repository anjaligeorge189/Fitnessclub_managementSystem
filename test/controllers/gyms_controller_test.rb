...
class GymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gym" do
    assert_difference('Gym.count') do
      post gyms_url, params: { gym: { duration: @gym.duration, package_ID: @gym.package_ID, package_name: @gym.package_name, price: @gym.price } }
    end
  ...
  test "should update gym" do
    patch gym_url(@gym), params: { gym: { duration: @gym.duration, package_ID: @gym.package_ID, package_name: @gym.package_name, price: @gym.price } }
